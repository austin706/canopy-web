...
export default function Signup() {
  ...
  const pwColors = ['', 'var(--color-error)', 'var(--color-warning)', 'var(--color-success)'];
        ...
        <div className="auth-card">
          ...
          <form onSubmit={handleSignup}>
            <div className="form-group">
              ...
              {fullNameError && <p style={{ color: 'var(--color-error)', fontSize: 13, marginTop: 4 }}>{fullNameError}</p>}
            </div>
            <div className="form-group">
              <label>Email</label>
            ...
            <div className="form-group">
              ...
              {confirmPasswordError && <p style={{ color: 'var(--color-error)', fontSize: 13, marginTop: 4 }}>{confirmPasswordError}</p>}
            </div>
            <div className="form-group">
              <label className="flex items-center gap-sm" style={{ cursor: 'pointer', fontSize: 13 }}>
                <input type="checkbox" checked={acceptedTerms} onChange={e => setAcceptedTerms(e.target.checked)} />
                <span style={{ color: 'var(--color-text-secondary)' }}>
                  I agree to the <a href="/terms" target="_blank" style={{ color: 'var(--color-copper)', textDecoration: 'none', fontWeight: 600 }}>Terms of Service</a> and <a href="/privacy" target="_blank" style={{ color: 'var(--color-copper)', textDecoration: 'none', fontWeight: 600 }}>Privacy Policy</a>
                </span>
              </label>

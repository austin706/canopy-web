  ...
  return (
    <div role="alert" style={{
      ...
      <div style={{ flex: 1, minWidth: 0 }}>
        ...
        <p style={{ fontSize: 14, fontWeight: 600, color: Colors.charcoal, margin: '2px 0 4px' }}> // allow-lint
          {neverInspected
            ? 'Add a Canopy Maintenance Inspection to your Home Token'
            : 'Time to refresh your Maintenance Inspection'}
        </p>
        <p style={{ fontSize: 12, color: Colors.medGray, margin: '0 0 10px', lineHeight: 1.4 }}> // allow-lint
          {neverInspected
